...
species-level changes [@jackson2012seeing]. Jackson et al. (2012) propose a
...
[R](http://www.R-project.org/) package [lme4](cran.r-project.org/package=lme4). 
...
([WAIC](http://www.stat.columbia.edu/~gelman/research/published/waic_understand3.pdf)),
...
effects. See 
[this GitHub repository](https://github.com/mbjoseph/MLM_EcologyInSilico) for 
...
(i.e. $logit^{-1}(\psi_q)$) of the best model that includes only significant 
...
[GitHub](https://github.com/mbjoseph/MLM_EcologyInSilico).
