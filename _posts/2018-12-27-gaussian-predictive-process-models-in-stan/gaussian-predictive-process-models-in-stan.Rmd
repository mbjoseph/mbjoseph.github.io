...
```{r plot-img, fig.height = 8, fig.width = 12}
library(imager)
im <- load.image("https://raw.githubusercontent.com/mbjoseph/gpp-speed-test/master/README_files/figure-html/unnamed-chunk-2-1.png")
plot(im, axes = FALSE)
```
...
```{r plot-img2, fig.height = 10, fig.width = 16, preview = TRUE}
im <- load.image("https://raw.githubusercontent.com/mbjoseph/gpp-speed-test/master/README_files/figure-html/unnamed-chunk-5-1.png")
plot(im, axes = FALSE)
```
