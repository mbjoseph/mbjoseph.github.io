...
description: |
  TLDR: you can teach design matrices from multiple perspectives.
author:
...
```{r plot-img, fig.cap="Katsushika Hokusai [Public domain]. Use different perspectives to improve concept delivery.", fig.height = 12, fig.width = 10}
library(imager)
im <- load.image("https://upload.wikimedia.org/wikipedia/commons/thumb/4/4e/Hokusai_sketches_-_hokusai_manga_vol6.jpg/675px-Hokusai_sketches_-_hokusai_manga_vol6.jpg")
plot(im, axes = FALSE)
```